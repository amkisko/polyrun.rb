...
RSpec.describe "Multi-Vite frontends", type: :system do
  ...
  it "isolates named sessions for admin, store, portal, and platform hubs", :multi_session do
    ...
    using_session(:portal) do
      visit portal_root_path
      expect(page).to have_css('body[data-app="portal"]')
      expect(page).to have_css('[data-testid="portal-heading"]')
    end
